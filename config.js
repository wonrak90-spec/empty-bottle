...
(function loadV22(){
  ...
  link.rel='stylesheet'; link.href='v22.css?v=20260917a'; document.head.appendChild(link);
  const boot=()=>{
    if(document.getElementById('v22Loader')) return;
    const s=document.createElement('script'); s.id='v22Loader'; s.src='v22.js?v=20260917a'; s.async=false; document.body.appendChild(s);
  };
